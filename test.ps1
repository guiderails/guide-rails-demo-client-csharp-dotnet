...
$proc = Start-Process "$VSINSTALLDIR_2017\Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" -ArgumentList "/EnableCodeCoverage netdemo-client\bin\Debug\netdemo-client.exe /Logger:trx" -PassThru -NoNewWindow
$proc.WaitForExit()
